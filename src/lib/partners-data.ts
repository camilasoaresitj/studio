...
export const partnerSchema = z.object({
  ...
  tipoFornecedor: z.object({
      ciaMaritima: z.boolean().optional().default(false),
      ciaAerea: z.boolean().optional().default(false),
      transportadora: z.boolean().optional().default(false),
      terminal: z.boolean().optional().default(false),
      coLoader: z.boolean().optional().default(false),
      fumigacao: z.boolean().optional().default(false),
      despachante: z.boolean().optional().default(false),
      representante: z.boolean().optional().default(false),
      dta: z.boolean().optional().default(false),
      comissionados: z.boolean().optional().default(false),
      administrativo: z.boolean().optional().default(false),
      aluguelContainer: z.boolean().optional().default(false),
      lashing: z.boolean().optional().default(false),
      seguradora: z.boolean().optional().default(false),
      advogado: z.boolean().optional().default(false),
  }).optional(),
  tipoAgente: z.object({
