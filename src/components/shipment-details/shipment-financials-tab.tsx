                                ...
                                {chargesFields.map((field, index) => {
                                    ...
                                    return (
                                        <TableRow key={field.id} data-state={isFaturado ? 'selected' : ''}>
                                            ...
                                            <TableCell className="p-1 align-top min-w-[150px]"><div className="flex gap-1"><FormField control={form.control} name={`charges.${index}.costCurrency`} render={({ field }) => (<Select onValueChange={field.onChange} value={field.value} disabled={isFaturado}><SelectTrigger className="h-8 w-[80px]"><SelectValue /></SelectTrigger><SelectContent><SelectItem value="BRL">BRL</SelectItem><SelectItem value="USD">USD</SelectItem></SelectContent></Select>)} /><span>{(charge.cost || 0).toLocaleString('pt-BR', {minimumFractionDigits: 2})}</span></div></TableCell>
                                            ...
                                            <TableCell className="p-1 align-top min-w-[150px]"><div className="flex gap-1"><FormField control={form.control} name={`charges.${index}.saleCurrency`} render={({ field }) => (<Select onValueChange={field.onChange} value={field.value} disabled={isFaturado}><SelectTrigger className="h-8 w-[80px]"><SelectValue /></SelectTrigger><SelectContent><SelectItem value="BRL">BRL</SelectItem><SelectItem value="USD">USD</SelectItem></SelectContent></Select>)} /><span>{(charge.sale || 0).toLocaleString('pt-BR', {minimumFractionDigits: 2})}</span></div></TableCell>
