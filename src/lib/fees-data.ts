...
const initialFeesData: Fee[] = [
    ...
    { id: 35, name: 'ENTREGA RODOVIÁRIA', value: '1500', currency: 'BRL', type: 'Opcional', unit: 'Por Processo', modal: 'Ambos', direction: 'Importação' },
    { id: 36, name: 'SERVIÇOS DE TRADING', value: '2500', currency: 'BRL', type: 'Opcional', unit: 'Por Processo', modal: 'Ambos', direction: 'Importação' },
];
